...
import './footer.css';
import payment_img from '../Assets/images/images.png';
...
function Footer() {
  return (
    ...
    <div className='footer-div'>
     ...
     <div>
        <img className='store-img' src={appstore}alt='app store'></img>
        <img className='store-img' src={playstore}alt='app store'></img>
      </div> 
      <div>
        <img></img>
        <img></img>
      ...
      <div className='payments-con'>
        ...
        <img src={payment_img} alt='payments' className='payment-img'></img>
      </div>
    </div>
    </div>
  )
